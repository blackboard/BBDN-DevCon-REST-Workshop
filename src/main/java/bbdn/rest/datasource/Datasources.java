...
public class Datasources extends BaseObject{

	/**
	 * An array of Datasources returned from the REST API Calls
	 */
	@JsonProperty("results")
  private Datasource[] results;
  ...
  public Datasources() {
	 ...
	 */
  public Datasource[] getResults() {
      return results;
  }

  public void setResults(Datasource[] results) {
