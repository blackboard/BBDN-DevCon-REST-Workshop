...
public class Calendars extends BaseObject{

	/**
	 * An array of Memberships returned from the REST API Calls
	 */
	@JsonProperty("results")
  private Calendar[] results;
  ...
  public Calendars() {
	 ...
	 */
  public Calendar[] getResults() {
      return results;
  }

  public void setResults(Calendar[] results) {
  ...
  public void setPaging(Paging paging) {
	...
	public String toString() {
		...
		return "Calendars [results=" + stringResults + ", paging=" + paging.toString() + ", " + super.toString() + "]";
	}
}
