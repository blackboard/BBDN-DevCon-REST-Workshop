...
public abstract class RestConstants {
	...
	public final static String SUFFIX = "smh";
	...
	public final static String DATASOURCE_ID = "BBDN-DSK-JAVA" + SUFFIX;
	...
	public final static String TERM_ID = "BBDN-TERM-SPRING" + SUFFIX;
	...
	public final static String COURSE_ID = "BIO-101" + SUFFIX;
	...
	public final static String USER_PROF_ID = "ProfessorPlum" + SUFFIX;
	...
	public final static String USER_STUD_ID = "AwesomeStudent" + SUFFIX;
